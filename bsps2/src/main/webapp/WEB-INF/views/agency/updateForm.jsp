...
<style>
    ...
    .update-card { background: white; border-radius: 20px; padding: 40px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.05); border: none; }
    .form-group label { font-weight: 600; color: #555; margin-bottom: 8px; font-size: 14px; display: flex; align-items: center; }
    .form-control, .custom-select { height: 50px; border-radius: 12px; border: 1px solid #e9ecef; background-color: #fcfcfc; padding: 10px 15px; transition: all 0.3s; font-size: 15px; }
    .form-control:focus { background-color: #fff; border-color: #4361ee; box-shadow: 0 0 0 4px rgba(67, 97, 238, 0.05); outline: none; }
    .location-input { background-color: #f0f4ff; border-color: #dbe4ff; }
    .btn-group-custom { display: flex; gap: 12px; margin-top: 40px; }
    .btn-submit { flex: 2; background-color: #4361ee; color: white; border: none; border-radius: 12px; height: 55px; font-weight: 700; font-size: 16px; transition: 0.3s; box-shadow: 0 4px 12px rgba(67, 97, 238, 0.2); }
    .btn-submit:hover { background-color: #3049c9; transform: translateY(-2px); box-shadow: 0 6px 15px rgba(67, 97, 238, 0.3); }
    .btn-cancel { flex: 1; background-color: #f1f3f5; color: #666; border: none; border-radius: 12px; height: 55px; font-weight: 600; display: flex; align-items: center; justify-content: center; text-decoration: none !important; transition: 0.2s; }
        ...
        <form action="update.do" method="post">
            ...
            <div class="form-row">
                <div class="form-group col-md-8">
                    <label for="agencyName"><i class="fas fa-building"></i> 기관 명칭 <span class="required">*</span></label>
                ...
                <div class="form-group col-md-4">
                    <label for="agencyType"><i class="fas fa-list"></i> 유형 <span class="required">*</span></label>
                    <select class="custom-select" id="agencyType" name="agencyType">
                        ...
                        <option value="기기타" ${vo.agencyType == '기타' ? 'selected' : ''}>기타</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="phone"><i class="fas fa-phone-alt"></i> 비상 연락처 <span class="required">*</span></label>
                    <input type="text" class="form-control" id="phone" name="phone" 
                           value="${vo.phone}" required placeholder="02-123-4567">
                </div>
                <div class="form-group col-md-6">
                    <label for="operatingHours"><i class="fas fa-clock"></i> 운영 시간</label>
            ...
            <div class="form-group">
                <label for="address"><i class="fas fa-map-marker-alt"></i> 기관 상세 주소 <span class="required">*</span></label>
                <input type="text" class="form-control" id="address" name="address" 
                       value="${vo.address}" required placeholder="주소를 입력해 주세요">
            </div>
