...
<div class="container">
    ...
    <main>
        ...
        <form action="update.do" method="post" id="editForm">
            ...
            <div class="input-group">
                <label>제목</label>
                <input type="text" name="title" placeholder="수정할 제목을 입력하세요" required>
            </div>

            <div class="input-group">
                <label>내용</label>
                <textarea name="content" placeholder="수정할 내용을 입력하세요" required></textarea>
            </div>
            ...
            <div class="btn-area">
                ...
                <button type="button" class="btn btn-cancel" 
                        onclick="location.href='view.do?no=${vo.no}&inc=0'">취소</button>
            </div>
        </form>
    </main>
